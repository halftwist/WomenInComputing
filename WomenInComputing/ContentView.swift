    ...
    var body: some View {
        VStack {
            HStack {
                Button {
                    //TODO: Button Action
//                    currentIndex = currentIndex == 0 ? bios.count - 1 : currentIndex - 1
                    currentIndex = (currentIndex - 1 + bios.count) % bios.count
//                    print("curent Index = \(currentIndex) bios.count= \(bios.count)")
                } label: {
                ...
                Button {
                    //TODO: Button Action
                    currentIndex = currentIndex >= bios.count - 1 ? 0 : currentIndex + 1
...
//                .cornerRadius(10)
            ...
            HStack {
                ...
                Button {
                    //TODO: Button Action
//                    newNumber =
//                    currentIndex = Int.random(in: 0...bios.count-1)
                    currentIndex = nonRepeatingRandom(lastNumber: currentIndex, upperBounds: bios.count-1)
